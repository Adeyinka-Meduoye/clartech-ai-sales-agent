...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#070a13] text-slate-100 flex flex-col font-sans select-none" id="app-container">
      ...
      <header className="bg-slate-900/40 backdrop-blur-md border-b border-slate-800/80 px-6 py-4 sticky top-0 z-40 flex items-center justify-between">
        ...
        <div className="flex bg-slate-950 p-1 rounded-xl border border-slate-800/80">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-semibold tracking-wide font-mono transition flex items-center gap-2 cursor-pointer ${
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg text-xs font-semibold tracking-wide font-mono transition flex items-center gap-2 cursor-pointer relative ${
